  ...
  return (
    <div className="middle">
      ...
      <div className="container" >
        <div className="cell" onClick={() => showCell('#cell1')}>cell1</div>
        <div className="cell" onClick={() => showCell('#cell2')}>cell2</div>
        <div className="cell" onClick={() => showCell('#cell3')}>cell3</div>
        <div className="cell" onClick={() => showCell('#cell4')}>cell4</div>
        <div className="cell" onClick={() => showCell('#cell5')}>cell5</div>
        <div className="cell" onClick={() => showCell('#cell6')}>cell6</div>
